const appName = 'simplett'; // alphanumeric only...
...
async function strykePut(endpointPath, recordId, data) {  
  const fullUrl = "https://api.stryke.io/v0/" + appName+ "/" + endpointPath + "/" + recordId;    
  const strykeToken = localStorage.getItem(authTokenName);
